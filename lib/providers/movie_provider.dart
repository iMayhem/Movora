...
class MovieProvider with ChangeNotifier {
  ...
  MovieProvider() {
    AdultFilterService.initialize();
  }

  // Performance optimization: Batch filtering operations
  List<Media> _filterAdultContent(List<Media> mediaList) {
    if (!AdultFilterService.isFilterEnabled || mediaList.isEmpty) {
      return mediaList;
    }

    // Use more efficient filtering
    final filteredList = <Media>[];

    for (final media in mediaList) {
      final shouldFilter = AdultFilterService.shouldFilterContent(
        title: media.title,
  ...
  Future<void> refreshAdultContentFilter() async {
    ...
    final operations = [
      () => _trendingNow = _filterAdultContent(_trendingNow),
  ...
  List<Media> _disasterMovies = [];
  List<Media> _heistMovies = [];
  List<Media> _buddyMovies = [];
  List<Media> _roadMovies = [];
  List<Media> _comingOfAge = [];
  List<Media> _periodDramas = [];
  List<Media> _noirMovies = [];
  List<Media> _cultClassics = [];
  List<Media> _blockbusters = [];
  List<Media> _arthouse = [];
  List<Media> _foreignLanguage = [];
  List<Media> _documentaryFeatures = [];
  List<Media> _shortFilms = [];
  List<Media> _experimental = [];
  List<Media> _silentMovies = [];
  List<Media> _remakes = [];
  List<Media> _sequels = [];
  List<Media> _prequels = [];
  List<Media> _spinOffs = [];
  List<Media> _franchiseMovies = [];
  ...
  List<Media> _romanticComedies = [];
  List<Media> _thrillerComedies = [];
  List<Media> _familyDramas = [];
  List<Media> _youthMovies = [];
  List<Media> _womenCentric = [];
  List<Media> _childrenMovies = [];
  ...
  List<Media> _festivalMovies = [];
  List<Media> _regionalCinema = [];
  List<Media> _parallelCinema = [];
  List<Media> _commercialCinema = [];
  List<Media> _artCinema = [];
  List<Media> _documentaryBollywood = [];
  List<Media> _shortFilmsBollywood = [];
  List<Media> _webSeriesHindi = [];
  List<Media> _tvShowsHindi = [];
  List<Media> _realityShowsHindi = [];
  List<Media> _gameShowsHindi = [];
  List<Media> _talkShowsHindi = [];
  List<Media> _varietyShowsHindi = [];
  List<Media> _newsShowsHindi = [];
  List<Media> _educationalShowsHindi = [];
  ...
  bool _isLoadingDisasterMovies = false;
  bool _isLoadingHeistMovies = false;
  bool _isLoadingBuddyMovies = false;
  bool _isLoadingRoadMovies = false;
  bool _isLoadingComingOfAge = false;
  bool _isLoadingPeriodDramas = false;
  bool _isLoadingNoirMovies = false;
  bool _isLoadingCultClassics = false;
  bool _isLoadingBlockbusters = false;
  bool _isLoadingArthouse = false;
  bool _isLoadingForeignLanguage = false;
  bool _isLoadingDocumentaryFeatures = false;
  bool _isLoadingShortFilms = false;
  bool _isLoadingExperimental = false;
  bool _isLoadingSilentMovies = false;
  bool _isLoadingRemakes = false;
  bool _isLoadingSequels = false;
  bool _isLoadingPrequels = false;
  bool _isLoadingSpinOffs = false;
  bool _isLoadingFranchiseMovies = false;
  ...
  bool _isLoadingRomanticComedies = false;
  bool _isLoadingThrillerComedies = false;
  bool _isLoadingFamilyDramas = false;
  bool _isLoadingYouthMovies = false;
  bool _isLoadingWomenCentric = false;
  bool _isLoadingChildrenMovies = false;
  bool _isLoadingFestivalMovies = false;
  bool _isLoadingRegionalCinema = false;
  bool _isLoadingParallelCinema = false;
  bool _isLoadingCommercialCinema = false;
  bool _isLoadingArtCinema = false;
  bool _isLoadingDocumentaryBollywood = false;
  bool _isLoadingShortFilmsBollywood = false;
  ...
  bool _isLoadingWebSeriesHindi = false;
  bool _isLoadingTvShowsHindi = false;
  bool _isLoadingRealityShowsHindi = false;
  bool _isLoadingGameShowsHindi = false;
  bool _isLoadingTalkShowsHindi = false;
  bool _isLoadingVarietyShowsHindi = false;
  bool _isLoadingNewsShowsHindi = false;
  bool _isLoadingEducationalShowsHindi = false;
  ...
  bool _isLoadingTrendingNetflix = false;
  ...
  bool _isLoadingTrendingPrime = false;
  ...
  bool _isLoadingTrendingAnimated = false;
  ...
  // Getters
  List<Media> get trendingNow => _trendingNow;
  ...
  List<Media> get trendingNetflix => _trendingNetflix;
  ...
  List<Media> get trendingPrime => _trendingPrime;
  ...
  List<Media> get trendingAnimated => _trendingAnimated;
  ...
  bool get isLoadingTrendingNetflix => _isLoadingTrendingNetflix;
  ...
  bool get isLoadingTrendingPrime => _isLoadingTrendingPrime;
  ...
  bool get isLoadingTrendingAnimated => _isLoadingTrendingAnimated;
  ...
  String? get trendingNetflixError => _trendingNetflixError;
  ...
  String? get trendingPrimeError => _trendingPrimeError;
  ...
  String? get trendingAnimatedError => _trendingAnimatedError;
  ...
  // Load trending now (top weekly)
  Future<void> loadTrendingNow() async {
    _isLoadingTrending = true;
    _trendingError = null;
    notifyListeners();

    try {
      _trendingNow = await TMDBService.getTopWeekly(limit: 12);
      // Apply adult content filter
      _trendingNow = _filterAdultContent(_trendingNow);
      _trendingError = null;
    } catch (e) {
      _trendingError = 'Failed to load trending content: $e';
  ...
  // Load Trending Netflix
  Future<void> loadTrendingNetflix() async {
    _isLoadingTrendingNetflix = true;
    _trendingNetflixError = null;
    notifyListeners();

    try {
      // Trending content on Netflix
      final results = await TMDBService.fetchCustomData('/discover/movie', {
        'watch_region': 'US',
        'with_watch_monetization_types': 'flatrate',
        'with_watch_providers': '8', // Netflix provider ID
      ...
      _trendingNetflix = results;
      _trendingNetflixError = null;
    } catch (e) {
      _trendingNetflixError = 'Failed to load Trending Netflix: $e';
      print('Error loading Trending Netflix: $e');
    } finally {
      _isLoadingTrendingNetflix = false;
      notifyListeners();
    }
  }
  ...
  // Load Trending Prime
  Future<void> loadTrendingPrime() async {
    _isLoadingTrendingPrime = true;
    _trendingPrimeError = null;
    notifyListeners();

    try {
      // Trending content on Prime
      final results = await TMDBService.fetchCustomData('/discover/movie', {
        'watch_region': 'US',
        'with_watch_monetization_types': 'flatrate',
        'with_watch_providers': '9', // Prime provider ID
      ...
      _trendingPrime = results;
      _trendingPrimeError = null;
    } catch (e) {
      _trendingPrimeError = 'Failed to load Trending Prime: $e';
      print('Error loading Trending Prime: $e');
    } finally {
      _isLoadingTrendingPrime = false;
      notifyListeners();
    }
  }
  ...
  // Load Trending Animated
  Future<void> loadTrendingAnimated() async {
    _isLoadingTrendingAnimated = true;
    _trendingAnimatedError = null;
    notifyListeners();

    try {
      // Trending animated content
      final results = await TMDBService.fetchCustomData('/discover/movie', {
        'with_genres': '16', // Animation
        'sort_by': 'popularity.desc',
        'vote_count.gte': '200',
      ...
      _trendingAnimated = results;
      _trendingAnimatedError = null;
    } catch (e) {
      _trendingAnimatedError = 'Failed to load Trending Animated: $e';
      print('Error loading Trending Animated: $e');
    } finally {
      _isLoadingTrendingAnimated = false;
      notifyListeners();
    }
  }
