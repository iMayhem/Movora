...
files = {
    # 1. MOVIE PAGE: Modern, responsive layout with glassmorphism details
...
""",
    ...
    # 2. TV SHOW PAGE: Matching aesthetic with Episode Selector
...
print("\nMobile UI optimized! Push to GitHub to see the new layout.")